...
Application metadata does not configure Vault servers, roles, or paths. Custom
platform services may define reviewed namespaced stores with dedicated Vault
roles; the MySQL platform is the first such integration. See the [Vault
contract](../vault/README.md) and [application chart
