...
- [`application-sets/`](application-sets/README.md) discovers managed, preview,
  and custom applications.
- [`charts/`](charts/README.md) contains the shared managed-application renderer.
- [`platform/`](platform/README.md) defines Applications for cluster services.
- [`projects/`](projects/README.md) defines source, destination, and resource
  permissions.
