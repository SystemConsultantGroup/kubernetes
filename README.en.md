...
change under [`applications/`](applications/README.en.md) or
[`argocd/`](argocd/README.en.md) can change
the live cluster.

## Application owners

Work in [`applications/`](applications/README.en.md) and submit a pull request.
...
[`applications/` guide](applications/README.en.md) for the file formats, examples, preview
...
> [`patches/`](patches/README.en.md) before an operation. `k reset` wipes the selected
...
- [`applications/`](applications/README.en.md) contains application metadata,
  digest-pinned instance lock files, and custom Kustomizations.
- [`argocd/`](argocd/README.en.md) contains the GitOps root, ApplicationSets,
  platform components, projects, and the shared application chart.
- [`patches/`](patches/README.en.md) contains shared and node-specific Talos patches.
- [`scripts/`](scripts/README.en.md) provides the `k` operator command and its help.
- [`secrets/`](secrets/README.en.md) contains the public recipient registry and
...
- [`workers/`](workers/README.en.md) contains Cloudflare Workers deployed outside Argo CD.
