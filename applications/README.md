...
shared [application delivery workflows](../.github/workflows/README.md). The workflow publishes an
...
explained in
[`../argocd/application-sets/README.md`](../argocd/application-sets/README.md).
